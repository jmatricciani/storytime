...
class Users extends Model {
  ...
  public $id,$username,$email,$password,$fname,$lname,$artist_name,$acl,$deleted = 0,$confirm;
  ...
  public function validator(){
    ...
    $this->runValidation(new RequiredValidator($this,['field'=>'artist_name','msg'=>'Artist Name is required.']));
