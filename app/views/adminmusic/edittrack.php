...
<?php $this->start('body'); ?>
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
      <?= FH::inputBlockAccept('image',"Change Track Image:",'mediaImage','',['class'=>'form-control'],['class'=>'form-group col-md-6'],$this->displayErrors) ?>
      <?= FH::inputBlockAccept('audio',"Change Track Audio:",'mediaAudio','',['class'=>'form-control'],['class'=>'form-group col-md-6'],$this->displayErrors) ?>
    </div>
