<?php $this->setSiteTitle('Upload Mix'); ?>
...
<?php $this->start('body'); ?>
  ...
  <h1 class="text-center">Upload Mix</h1>
  <form action="<?=$this->formAction?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
      <?= FH::inputBlockAccept('image',"Upload Mix Image:",'mediaImage','',['class'=>'form-control'],['class'=>'form-group col-md-6'],$this->displayErrors) ?>
    </div>
    <div class="row">
      <?= FH::inputBlockAccept('audio',"Upload Mix Audio:",'mediaAudio','',['class'=>'form-control'],['class'=>'form-group col-md-6'],$this->displayErrors) ?>
    </div>
    <div class="row">
